...
#ifndef CellTexture_hpp
#define CellTexture_hpp
...
{
public:
    enum PieceType{PIECE_KING, PIECE_PAWN, PIECE_ROOK, PIECE_QUEEN, PIECE_KNIGHT, PIECE_BISHOP, PIECE_LEGALMOVE, PIECE_EMPTY};
    ...
    void render( int x, int y, CellTexture::PieceType pieceType);
